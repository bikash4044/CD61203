#This program assign the Drainage line treatment structures to the shapefile based on conditions
#To use enter the path the channel network shapefile to the variable "vector"
